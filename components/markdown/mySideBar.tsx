...
export function SideBar({
  ...
  return (
    <div
      id="default-sidebar"
      className="w-full md:w-64 md:h-full transition-transform"
      aria-label="Sidebar"
    >
      <div className="md:h-full px-3 py-4 overflow-y-auto overflow-x-hidden bg-gray-50 dark:bg-gray-800">
